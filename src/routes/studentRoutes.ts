...
import { studentIndex, setStudentRegStatus, setStudentCourseSuggest, StudentFromCourse, deleteStudent, studentCreate, studentUpdate, educationHistory, parent, StudentFromAcademicCourseId, semCourseReg } from '../controllers/studentControllers';
